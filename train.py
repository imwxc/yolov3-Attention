...
if __name__ == "__main__":
    ...
    os.makedirs( "checkpoints\\{}\\{}".format(opt.data_config[7:-5],opt.model_def[7:-4]),exist_ok=True)
    ...
    for epoch in range(opt.epochs):
            ...
            if metrics_output is not None:
                ...
                for i, c in enumerate(ap_class):
                    try:
                        ...
                        print("AP length ",len(AP),"-----   i:",i)
                        print("class_names: ",class_names ,"----- c:",c)
        ...
        if epoch % opt.checkpoint_interval == 0:
            torch.save(model.state_dict(), "checkpoints\\{}\\{}\\{}.pth".format(opt.data_config[7:-5],opt.model_def[7:-4],epoch))
            
    torch.save(model.state_dict(), "checkpoints\\{}\\{}\\final.pth".format(opt.data_config[7:-5],opt.model_def[7:-4]))
